...
public class TestDB {
	...
	public void reset() {
		...
		String[] tables = { "in_out_events", "message_events", "permission_events", "request_events", "map_events",
				"map_objects", "events", "members", "users", "incidents" };
		String sql = "";
	...
	public void run() {
		...
		GPSPosition[] polyCoords2 = { new GPSPosition(3, 3), new GPSPosition(1, 10), new GPSPosition(2, 30),
				new GPSPosition(4, 1) };
	...
	public void addProfiles() {
		EIMAProfile[] profiles = { new EIMAProfile(users[0], "Dayton", "DF", "", "Fire"),
	...
	public void seeAssets(String token) {
		...
		for (EIMAAsset asset : a) {
			System.out.println("uid:" + asset.getUsername() + "\n" + "name:" + asset.getName() + "\n" + "status:"
					+ asset.getStatus() + "\n" + "unit:" + asset.getUnit() + "\n" + "unitType:" + asset.getUnitType()
					+ "\n" + "pos:" + asset.getPosition().getLatitude() + "," + asset.getPosition().getLongitude());
		}
		System.out.println("Circles:");
		for (EIMACircle asset : c) {
			System.out.println("uid:" + asset.getUid() + "\n" + "type:" + asset.getType() + "\n" + "radius:"
					+ asset.getRadius() + "\n" + "notes:" + asset.getNote() + "\n" + "pos:"
					+ asset.getCenter().getLatitude() + "," + asset.getCenter().getLongitude());
		}

...
public class EIMARouting {
	...
	public Validate putExample(String json) throws JSONException {				
        ...
        @POST
        @Consumes(MediaType.TEXT_PLAIN)
        public boolean validatePrivilege(String token, String incidentID, String requiredPrivLevel){
        ...
        public boolean create(String token){
            // validate the token
            // if valid:
            // create a new incident id, set user level to admin, store in database
            return true;
            // if invalid:
            // return false;
        }
        ...
        public boolean registerUser(String username, String password, String profileData){
        ...
        public boolean location(String token, double Latitude, double Longitute){
            // validate the token 
            // if valid:
        ...
        public boolean sendMessage(String Token, String username, String message){
            // validate the token 
            // if valid:
            // validate privilege
            // if valid:
        ...
        public boolean editPrivilege(String Token, String username, String privilegeLevel){
            // validate the token 
            // if valid:
            // validate privilege
            // if valid:
